...
@HippoEssentialsGenerated(internalName = "ootb:faqlist")
@Node(jcrType = "ootb:faqlist")
public class FaqList extends BaseDocument {
	...
	@HippoEssentialsGenerated(internalName = "ootb:faqitem")
    public List<FaqItem> getFaqItems() {
        return getLinkedBeans("ootb:faqitem", FaqItem.class);
    }
